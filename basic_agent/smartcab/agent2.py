...
class LearningAgent(Agent):
    ...
    def __init__(self, env):
        ...
        #number of  success try for agent  to  reach the destination.
        self.max_trials = 100  
        #         self.max_trials = 10  
...
#my update
    ...
    def update(self, t):
        ...
        print("inputs is :: \n {}. Deadline is  :: '{}'. Time is {}"\
              ...
              .format(inputs, deadline, t, self.state))	 
		  
        result_before = "{},{},{},{},{}\n".format(inputs, deadline, t, self.state ,self.env.done)
        with open("result_before2.csv", "a") as myfile:
                myfile.write(result_before)   
				
        #action  is  based on  planner.
        ...
        result = "{},{},{},{},{},{},{},{},{}\n".format(inputs_oncoming,inputs_left, inputs_right,self.next_waypoint,inputs['light'], action, reward,t,self.env.done)
        with open("agentprint2.csv", "a") as myfile:
                myfile.write(result) 
...
##Write statics data to file  ###########            
            ...
            with open("success_total_agent2.csv", "a") as myfile:
                myfile.write(result) 
#########################################               
